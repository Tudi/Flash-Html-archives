...
//if uid changed then we should display the new values
...
close_database();
print("<Form Name=getuserinfo method=POST Action=modify_user.php?user_id=$user_id target=_self>");
...
print("<tr><td>Part of Groups (separeted by space !! VALID NAMES) : </td><td><input type='text' name='group' value=\"".$t2."\"></td></tr>");
print("</table>");
