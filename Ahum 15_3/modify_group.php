...
$sql_query="select isadmin,gid,name,gname,tname,comment,homepath from groups where groups.gid=".$old_gid2." and isadmin=\"0\"";
$result = search_database($sql_query,"mod_group.php : list all the groups $old_gid2");
$line = mysql_fetch_array($result, MYSQL_ASSOC);
close_database();
?>
<form action="modify_group.php" method="post" name="get_group_data" target="_self">
