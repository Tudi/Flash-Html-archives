...
print("<center><h2><strong>Select a Group from the list to view or modify it</strong></h2></center><br>");
...
while ( $line = mysql_fetch_array($result, MYSQL_ASSOC))
	{
			print("<tr>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[gid]</a></td>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[gname]</a></td>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[name]</a></td>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[tname]</a></td>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[comment]</a></td>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[homepath]</a></td>");
			print("<td  align=center><a href='modify_admin_group.php?old_gid=$line[gid]' target='_self'>$line[isadmin]</a></td>");
			print("</tr>");
	}
print("</table>");
close_database();
