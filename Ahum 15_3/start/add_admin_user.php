...
<form name="getuserinfo" method="post" action="add_admin_user.php" target="_self">
...
//			      <td bgcolor="#990000"> <input type="text" class=fontos name="t_groups"> </td>
				 ...
				 open_database();
				 $query="select gname from groups ORDER BY gname desc";
 ...
 function checkfill() 
  {
		...
		if (a.s_group.value == "") { alert ("Please, select a group name !"); a.s_group.focus(); return; }
		a.submit();  }
</script>
