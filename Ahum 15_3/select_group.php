...
while ( $line = mysql_fetch_array($result, MYSQL_ASSOC))
	{
			print("<tr>");
			print("<td  align=center><a href='modify_group.php?old_gid=$line[gid]' target='_self'>$line[gid]</a></td>");
			print("<td  align=center><a href='modify_group.php?old_gid=$line[gid]' target='_self'>$line[gname]</a></td>");
			print("<td  align=center><a href='modify_group.php?old_gid=$line[gid]' target='_self'>$line[name]</a></td>");
			print("<td  align=center><a href='modify_group.php?old_gid=$line[gid]' target='_self'>$line[tname]</a></td>");
			print("<td  align=center><a href='modify_group.php?old_gid=$line[gid]' target='_self'>$line[comment]</a></td>");
			print("<td  align=center><a href='modify_group.php?old_gid=$line[gid]' target='_self'>$line[homepath]</a></td>");
			print("</tr>");
	}
print("</table>");
close_database();
